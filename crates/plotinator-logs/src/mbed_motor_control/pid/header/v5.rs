...
pub(crate) struct PidLogHeaderV5 {
    #[serde(with = "BigArray")]
...
impl BuildMbedLogHeaderV2<MbedConfigV4> for PidLogHeaderV5 {
    fn new(
        unique_description: UniqueDescriptionData,
        version: u16,
        project_version: ProjectVersionData,
...
impl GitMetadata for PidLogHeaderV5 {
...
impl MbedMotorControlLogHeader for PidLogHeaderV5 {
    const VERSION: u16 = 5;
...
impl fmt::Display for PidLogHeaderV5 {
