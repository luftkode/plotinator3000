...
impl StatusLogHeaderV6 {
    pub(crate) fn mbed_config(&self) -> &MbedConfigV4 {
        &self.mbed_config
    }
}

impl BuildMbedLogHeaderV2<MbedConfigV4> for StatusLogHeaderV6 {
    fn new(
        unique_description: UniqueDescriptionData,
        version: u16,
        project_version: ProjectVersionData,
...
impl GitMetadata for StatusLogHeaderV6 {
...
impl MbedMotorControlLogHeader for StatusLogHeaderV6 {
    const VERSION: u16 = 2;
...
impl fmt::Display for StatusLogHeaderV6 {
