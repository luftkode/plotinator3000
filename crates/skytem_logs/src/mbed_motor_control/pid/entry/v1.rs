...
impl LogEntry for PidLogEntryV1 {
...
impl fmt::Display for PidLogEntryV1 {
...
mod tests {
    ...
    fn test_from_reader_success() {
        ...
        let (entry, bytes_read) = PidLogEntryV1::from_reader(&mut cursor).unwrap();
    ...
    fn test_from_reader_incomplete_data() {
        ...
        let mut cursor = Cursor::new(data);
        let result = PidLogEntryV1::from_reader(&mut cursor);
